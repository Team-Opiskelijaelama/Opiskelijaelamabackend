...
public class OpiskelijaelamaApplication {
	...
	public CommandLineRunner tapahtumaDemo(TapahtumaRepository tapahtumaRepo, TehtavaRepository tehtavaRepo, JuomapeliRepository peliRepo, LauluRepository lauluRepo) {
		return (args) -> {
			...
			lauluRepo.save(new Laulu("Helan går", "En liten fågel satt en gång och sjöng i furuskog. Den hade sjungit dagen lång, men dock ej sjungit nog. Vad sjöng den lilla fågeln då? JOO! Helan går, sjung hopp-fa-de-ral-lan-lal-lan-lej! Helan går, sjung hopp-fa-de-ral-lan-lej! Och den som inte Helan tar, han ej heller Halvan får. Helan går- sjung hopp-fa-de-ral-lan-lej!", "","", true));		
